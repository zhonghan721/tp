...
public class ArgumentMultimap {
     ...
     */
    public boolean arePrefixesAbsent(Prefix... prefixes) {
        return Stream.of(prefixes).allMatch(prefix -> this.getValue(prefix).isEmpty());
    }

    /**
     * Returns true if preamble is empty.
     */
    public boolean isEmptyPreamble() {
