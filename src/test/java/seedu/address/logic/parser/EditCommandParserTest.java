...
public class EditCommandParserTest {
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        descriptor = new CustomerEditDescriptorBuilder().withTags(VALID_TAG_FRIEND).build();
        expectedCommand = new CustomerEditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_resetTags_success() {
        ...
        CustomerEditDescriptor descriptor = new CustomerEditDescriptorBuilder().withTags().build();
        CustomerEditCommand expectedCommand = new CustomerEditCommand(targetIndex, descriptor);
