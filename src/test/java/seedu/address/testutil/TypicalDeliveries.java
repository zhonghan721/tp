...
public class TypicalDeliveries {
    public static final Delivery GABRIELS_MILK = new DeliveryBuilder().withId(1).withName("Gabriel's Milk")
        .withCustomer(TypicalPersons.ALICE).build();

    public static final Delivery GAMBES_RICE = new DeliveryBuilder().withId(2).withName("Gambes Rice")
