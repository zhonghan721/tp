...
4. If all fields are present, it creates a new `userLoginCommand`.
5. The `userLoginCommand` checks whether the user is currently logged in by calling `Model#getUserLoginStatus()`.
