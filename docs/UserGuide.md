...
### </br>Update details of a Customer
...
#### </br>Update details of a Delivery
...
### </br>Update status of a Delivery
...
| View    | `customer view CUSTOMER_ID`{.swift}                                                                          | `customer view 1`{.swift}{swift}                                                                                                 |
